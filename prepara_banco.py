...
usuarios = [
    ('Douglas', 'edmaker', generate_password_hash('reset666').decode('utf-8')),
    ('Vanessa', 'lost12', generate_password_hash('morango62').decode('utf-8')),
    ('Euclides', 'cride', generate_password_hash('montandor123').decode('utf-8'))
]
